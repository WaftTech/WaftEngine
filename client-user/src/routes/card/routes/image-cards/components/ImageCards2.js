...
const Section = () => {
  return(
    <article className="article">
      ...
      <article className="img-card-v2 mdc-elevation--z1 mb-4" style={{height: '350px'}}>
      ...
      <article className="img-card-v2 mdc-elevation--z1 text-body-reverse mb-4" style={{height: '500px'}}>
