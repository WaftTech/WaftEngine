  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="media icon-card-v1">
            <div className={`icon-card__icon icon--circle mr-3 bg-${card.color}`}><MaterialIcon icon={card.icon} /></div>
            <div className="media-body">
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="media icon-card-v1">
            <div className={`icon-card__icon icon--outlined mr-3 border-${card.color}`}><MaterialIcon icon={card.icon} className={`bg-${card.color}`}/> </div>
            <div className="media-body">
              <h4 className="icon-card__header">{card.title}</h4>
              <div className="icon-card__content">{card.content}</div>
            </div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="media icon-card-v1">
            <div className={`icon-card__icon icon--bordered mr-3 border-${card.color}`}><MaterialIcon icon={card.icon} className={`text-${card.color}`}/> </div>
            <div className="media-body">
              <h4 className="icon-card__header">{card.title}</h4>
              <div className="icon-card__content">{card.content}</div>
            </div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="media icon-card-v1">
            <div className={`icon-card__icon icon--rounded mr-3 bg-${card.color}`}><MaterialIcon icon={card.icon} /></div>
            <div className="media-body">
              <h4 className="icon-card__header">{card.title}</h4>
              <div className="icon-card__content">{card.content}</div>
            </div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="media icon-card-v1">
            <div className="icon--plain mr-3"><MaterialIcon icon={card.icon} className={`text-${card.color}`} /></div>
            <div className="media-body">
              <h4 className="icon-card__header">{card.title}</h4>
              <div className="icon-card__content">{card.content}</div>
            </div>
      ...
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="icon-card-v2">
            <div className="media">
              <div className="icon--plain icon--sm mr-3"><MaterialIcon icon={card.icon} className={`text-${card.color}`} /></div>
              <div className="media-body">
                <h4 className="icon-card__header">{card.title}</h4>
              </div>
            </div>
