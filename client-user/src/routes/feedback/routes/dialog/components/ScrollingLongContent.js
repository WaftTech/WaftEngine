...
class ScrollDialog extends React.Component {
  ...
  render() {
    return (
      <div>
        <OutlinedButton onClick={this.handleClickOpen('paper')}>scroll=paper</OutlinedButton>
        <OutlinedButton onClick={this.handleClickOpen('body')} className="ml-3">scroll=body</OutlinedButton>
        <Dialog
...
const Box = () => (
  <div className="box box-default">
    <div className="box-header">Scrolling Long Content</div>
    <div className="box-body text-center py-4">
      <ScrollDialog />
    </div>
  </div>
)
