  ...
  <section>
        ...
        <div className="box-body p-0">
          <div className="row">
            ...
            <div className="col-xl-8">
              <img src="assets/md/style_typography_roboto1.png" alt="" className="img-fluid" />
            </div>
          </div>
        </div>
      </div>
    ...
    <article className="article">
      ...
      <div className="row no-gutters">
          ...
          <div className="box box-default mb-3">
            ...
            <div className="box-body">
              ...
              <blockquote className="blockquote">
                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit excepturi enim rerum dolore nostrum.</p>
        ...
        <div className="col-xl-9">
          <div className="box box-default mb-3">
            <div className="box-header">Center</div>
            <div className="box-body">
