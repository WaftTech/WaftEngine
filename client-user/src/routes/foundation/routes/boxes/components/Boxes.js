...
const BasicBoxes = () => (
  <article className="article">
    <h2 className="article-title page-title">Boxes</h2>
    <div className="row">
      <div className="col-xl-4">
        <div className="box box-v1 mb-4">
          ...
          <a href={DEMO.link} className="link-cta link-animated-hover link-hover-v1">Link <MaterialIcon icon="arrow_forward" /></a>
        </div>
      </div>
      <div className="col-xl-4">
        <div className="box box-v1 mb-4">
...
const BoxesWithStyle = () => (
  <article className="article">
    ...
    <div className="row">
      ...
      <div className="col-xl-4">
        <div className="box box-default box-transparent mb-4">
    ...
    <div className="row">
      <div className="col-xl-4">
        <div className="box box-default box-flat mb-4">
          <div className="box-header">Flat box</div>
          <div className="box-body">
            This is the body of box component. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, quasi nam. Nisi assumenda nulla consequatur perferendis, voluptatum, laborum provident eos amet quos, ullam possimus facilis quasi? Magnam optio voluptates ipsam.
          </div>
        </div>
      ...
      <div className="col-xl-4">
        <div className="box box-default box-flat bg-transparent mb-4">
