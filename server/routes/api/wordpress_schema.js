...
async function validate(req, res, next) {
  req
    .checkBody("heading", "Enter Valid Heading")
    .exists()
    .notEmpty();
  req
    .checkBody("title", "Enter valid Title")
    .exists()
    .notEmpty();
  req
    .checkBody("content", "Enter Content")
    .exists()
    .notEmpty();
  req
    .checkBody("domain", "Enter valid Domain")
    .exists()
    .notEmpty();
...
function validatewordpressInput(req, res, next) {
  ...
  validator.isEmpty(data.heading)
    ? (errors.heading = "Heading is invalid")
    : null;
