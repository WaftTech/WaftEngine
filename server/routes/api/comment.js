...
const { authorization, authentication,commmentauthorization } = require('../../middleware/authentication.middleware');
...
router.post('/', commmentauthorization, sanitizeComment, validateComment, commentModule.PostComment);
