module.exports = {
  validationMessage: {
    ...
    senderInvalidLength: 'Sender Name must be atleast 5 characters, max limit 30 characters',
    receiverInvalidLength: 'Receiver Name must be atleast 5 characters, max limit 30 characters',
    senderRequired: 'Sender Name field is required',
