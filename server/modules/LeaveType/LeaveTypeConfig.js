module.exports = {
  ValidationMessage: {
    LeaveNameRequired: ' Leave type must be entered',
    LeaveNameInvalidlength: ' Leave type must be atleast 5 characters, maximum limit is 50',
    ApplicableGenderRequired: 'Applicable Gender must be entered',
