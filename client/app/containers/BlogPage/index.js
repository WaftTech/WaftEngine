...
export class BlogPage extends React.Component {
  ...
  render() {
    ...
    const tableData = allLinksObj.map(({ BlogTitle, Description, Added_by, Added_at }) => [
      BlogTitle,
      Description,
      Added_by, moment(Added_at).format("MMM Do YY"),
      <React.Fragment>
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              ...
              <p className={classes.cardCategoryWhite}>Here are the list of blogs</p>
            </CardHeader>
            <CardBody>
