...
export const loadVideoRequest = payload => ({
  type: types.LOAD_VIDEO_REQUEST,
  payload,
});
export const loadVideoSuccess = payload => ({
  type: types.LOAD_VIDEO_SUCCESS,
  payload,
});
export const loadVideoFailure = payload => ({
  type: types.LOAD_VIDEO_FAILURE,
  payload,
});
