...
export class OrganizationInfoPage extends React.Component {
  handleAdd = () => {
    this.props.history.push('/wt/articles-manage/add');
  };
  handleEdit = id => {
    this.props.history.push(`/wt/articles-manage/edit/${id}`);
  };
  handleDelete = id => {
    // shoe modal && api call
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>Article Listing</h4>
