...
const hexToRgb = input => {
  ...
  input = input.replace('#', ''); // eslint-disable-line no-param-reassign
  ...
  if (input.length === 3) {
    ...
    const last = input[2];
    input = first + first + second + second + last + last; // eslint-disable-line no-param-reassign
  }
  input = input.toUpperCase(input); // eslint-disable-line no-param-reassign
...
const primaryColor = ['#007AFF', '#007AFF', '#007AFF', '#007AFF'];
const warningColor = ['#ff9800', '#ffa726', '#fb8c00', '#ffa21a'];
const dangerColor = ['#f44336', '#ef5350', '#e53935', '#f55a4e'];
const successColor = ['#4caf50', '#66bb6a', '#43a047', '#5cb860'];
const infoColor = ['#02B7DD', '#02B7DD', '#02B7DD', '#02B7DD'];
