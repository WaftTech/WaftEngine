Client side is a forked extension of popular [react-boilerplate project](https://github.com/react-boilerplate/react-boilerplate) on github. We add various components and modules to the project.
