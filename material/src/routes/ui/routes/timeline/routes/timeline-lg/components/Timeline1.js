      ...
      <article className="tl-item">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-info"><MaterialIcon icon="camera" /></div>
      ...
      <article className="tl-item alt">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-warning"><MaterialIcon icon="shop" /></div>
            <div className="tl-content">
      ...
      <article className="tl-item">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-success"><MaterialIcon icon="camera" /></div>
            <div className="tl-content">
              <h4 className="tl-title text-warning">Soluta nihil</h4>
              <img src="assets/images-demo/assets/600_400-4.jpg" className="rounded img-fluid" alt="cover"/>
      ...
      <article className="tl-item alt">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-danger"><MaterialIcon icon="check" /></div>
            <div className="tl-content">
              <h4 className="tl-title text-success">Odio sit odit necessitatibus</h4>
              <img src="assets/images-demo/assets/600_400-1.jpg" className="rounded img-fluid" alt="cover"/>
              <p>Ullam, commodi, modi, impedit nostrum odio sit odit necessitatibus accusantium enim voluptates culpa cupiditate cum pariatur a recusandae tenetur aspernatur at beatae.</p>
            </div>
          </div>
        </div>
      ...
      <article className="tl-item">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-primary"><MaterialIcon icon="music_video" /></div>
            <div className="tl-content">
      ...
      <article className="tl-item alt">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-warning"><MaterialIcon icon="message" /></div>
            <div className="tl-content">
      ...
      <article className="tl-item">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-success"><MaterialIcon icon="folder" /></div>
            <div className="tl-content">
      ...
      <article className="tl-item alt">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-danger"><MaterialIcon icon="message" /></div>
            <div className="tl-content">
      ...
      <article className="tl-item">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-primary"><MaterialIcon icon="mail" /></div>
            <div className="tl-content">
      ...
      <article className="tl-item alt">
        <div className="tl-body">
          <div className="tl-entry">
            ...
            <div className="tl-icon icon-btn-round icon-btn icon-btn-thin btn-info"><MaterialIcon icon="card_giftcard" /></div>
            <div className="tl-content">
