    ...
    <div className="container-fluid no-breadcrumb container-mw-xxl chapter">
      <article className="article">
        ...
        <QueueAnim type="bottom" className="ui-animate">
          <div className="mb-5" key="1"><Footer1 /></div>
          <div className="mb-5" key="2"><Footer2 /></div>
          <div className="mb-5" key="3"><Footer3 /></div>
          <div className="mb-6" key="4"><Footer4 /></div>
          <div className="article__section" key="5"><Elements /></div>
        </QueueAnim>
      </article>
    </div>
  );
