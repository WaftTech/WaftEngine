...
const FAQs = () => (
  <article className="article py-7 article-dark article-bordered">
    <div className="container-fluid container-mw-lg">
        ...
        <h5>Doloribus dolores, officia voluptatibus deserunt ratione debitis laboriosam?</h5>
        ...
        <h5>Illo recusandae beatae facilis?</h5>
        ...
        <h5>Quidem doloribus, repudiandae?</h5>
        ...
        <h5>Assumenda accusamus reiciendis obcaecati iusto?</h5>
        ...
        <h5>Alias harum culpa earum cum id aspernatur repellendus aliquam?</h5>
        ...
        <h5>Optio doloremque suscipit aut accusantium maxime provident cumque?</h5>
