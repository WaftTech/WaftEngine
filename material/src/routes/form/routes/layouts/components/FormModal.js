...
class FormModal1 extends React.Component {
  ...
  render() {
    return (
      <div>
        <Button variant="contained" onClick={this.showModal}>Open a modal form v1</Button>
        <Modal
...
class FormModal2 extends React.Component {
  ...
  render() {
    return (
      <div>
        <Button variant="contained" onClick={this.showModal}>Open a modal form v2</Button>
        <Modal
          visible={this.state.visible}
          onCancel={this.handleCancel}
          footer={null}
...
class FormModal3 extends React.Component {
  ...
  render() {
    return (
      <div>
        <Button variant="contained" onClick={this.showModal}>Open a modal form v3</Button>
        <Modal
          visible={this.state.visible}
          onCancel={this.handleCancel}
          footer={null}
