  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="icon-card-v1 icon-card--center">
            <div className={`icon-card__icon icon--circle bg-${card.color}`}><MaterialIcon icon={card.icon} /></div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="icon-card-v1 icon-card--center">
            <div className={`icon-card__icon icon--outlined border-${card.color}`}><MaterialIcon icon={card.icon} className={`bg-${card.color}`}/> </div>
            <h4 className="icon-card__header">{card.title}</h4>
            <div className="icon-card__content">{card.content}</div>
          </div>
        </div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="icon-card-v1 icon-card--center">
            <div className={`icon-card__icon icon--bordered border-${card.color}`}><MaterialIcon icon={card.icon} className={`text-${card.color}`}/> </div>
            <h4 className="icon-card__header">{card.title}</h4>
            <div className="icon-card__content">{card.content}</div>
          </div>
        </div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="icon-card-v1 icon-card--center">
            <div className={`icon-card__icon icon--rounded bg-${card.color}`}><MaterialIcon icon={card.icon} /></div>
            <h4 className="icon-card__header">{card.title}</h4>
            <div className="icon-card__content">{card.content}</div>
          </div>
        </div>
  ...
  <div className="row mb-5">
    {
      cards.map((card, i) => (
        <div className="col-xl-4 mb-4" key={i.toString()}>
          <div className="icon-card-v1 icon-card--center">
            <div className="icon--plain"><MaterialIcon icon={card.icon} className={`text-${card.color}`} /></div>
            <h4 className="icon-card__header">{card.title}</h4>
            <div className="icon-card__content">{card.content}</div>
          </div>
        </div>
