...
export function changeTheme(themeOption) {
  return { type: types.CHANGE_THEME, themeOption: themeOption }
}
export function toggleHeaderShadow(hasHeaderShadow) {
  return { type: types.TOGGLE_HEADER_SHADOW, hasHeaderShadow: hasHeaderShadow }
}
export function toggleSidenavShadow(hasSidenavShadow) {
  return { type: types.TOGGLE_SIDENAV_SHADOW, hasSidenavShadow: hasSidenavShadow }
}
